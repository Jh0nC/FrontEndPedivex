        ...
        <div className="container mx-auto p-6">
            <div className="card">
                <div className="card-header">
                    <h2 className="text-2xl font-bold">Product Return</h2>
                </div>
                <div className="card-body">
                    ...
                    {saleInfo && (
                        <div className="mb-4 bg-light p-3 rounded">
                            ...
                            <p><strong>Customer:</strong> {`${saleInfo.user.firstName} ${saleInfo.user.lastName}`}</p>
                        ...
                        <div key={index} className="card mb-3">
                            <div className="card-body">
                                <div className="d-flex justify-content-between align-items-center mb-3">
                                    <h4 className="card-title">Product Return</h4>
                                    <button 
                                        className="btn btn-outline-danger btn-sm"
                                        onClick={() => removeReturnDetail(index)}
                                    >
                                        <Trash2 className="me-1" size={16} /> Remove
                                    </button>
                                </div>
                                ...
                                <div className="row g-3">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        {errors[`${index}-quantity`] && (
                                            <small className="text-danger">{errors[`${index}-quantity`]}</small>
                                        )}
                                        <small className="form-text text-muted">
                                            Max: {detail.maxQuantity} units
                                        </small>
                                    </div>

                                    <div className="col-md-6">
                                        <label className="form-label">Return Motive</label>
                                        <select 
                                    ...
                                    <div className="col-md-6">
                                        <label className="form-label">Changed Product</label>
                                        <select 
                                    ...
                                    <div className="col-md-6">
                                        <label className="form-label">Changed Quantity</label>
                                        <input
                                            type="number"
